  ...
  return (
    <div className="flex flex-col min-h-screen bg-background page-enter">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl pt-16 pb-16">
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1748!2d76.3477644!3d29.8175491!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3911e7d72929f60b%3A0x3b9667c80e4de39!2sSunrise%20Senior%20Secondary%20School!5e0!3m2!1sen!2sin!4v1714836000000!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
