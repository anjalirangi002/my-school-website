        ...
        <div className="space-y-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <img src="/images/sports.jpg" alt="Sports Day" className="w-full h-auto rounded-3xl shadow-xl" />
            </div>
          </div>
          
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img src="/images/cultural.jpg" alt="Cultural Event" className="w-full h-auto rounded-3xl shadow-xl" />
            </div>
            <div>
